...
public class FuncionarioView extends JFrame {
	...
	public FuncionarioView() {
		...
		btnNewButton.setBounds(242, 80, 114, 36);
		...
		btnEditar.setBounds(82, 143, 114, 36);
		...
		btnRemover.setBounds(242, 143, 114, 36);
		contentPane.add(btnRemover);
		
		JButton button_1 = new JButton("Listar");
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ListarFuncionarioView n = new ListarFuncionarioView();
				n.setVisible(true);
			}
		});
		button_1.setFont(new Font("Tahoma", Font.PLAIN, 18));
		button_1.setBounds(82, 80, 115, 37);
